...
import ThreeDDressCode from '../../components/invitation/ThreeDDressCode'
...
export default function SimpleLuxuryTemplate({ lang, setLang, weddingData, onBack, isDemoMode = false, initialGuestbook }) {
  ...
  /* Qalereya/QR/masa kartı məntiqi — hooks/useGallery.js */
  /* downloadTableCard simple-luxury-də istifadə olunmur (əvvəl də ölü kod idi) —
     hook-da qalır, floral-garden onu "Masa kartını yüklə" düyməsində işlədir. */
