...
/* ⚠ Burada `transition` YOXDUR: ortaq `[data-press]` qaydası (index.css)
   transform/box-shadow/filter keçidlərini özü verir, inline transition isə
   onu üzərinə yazardı. */
const ICON_WRAP = {
...
function SocialIcons({ color, border }) {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 16 }}>
      <a data-press href={SOCIAL_LINKS.instagram} aria-label="Instagram" target="_blank" rel="noopener noreferrer" style={wrap}>
      ...
      <a data-press href={SOCIAL_LINKS.tiktok} aria-label="TikTok" target="_blank" rel="noopener noreferrer" style={wrap}>
        <svg width="15" height="15" viewBox="0 0 24 24" fill={color}>
          <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.32 6.32 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.75a4.85 4.85 0 0 1-1.01-.06z" />
        </svg>
      </a>
      <a data-press href={SOCIAL_LINKS.whatsapp} aria-label="WhatsApp" target="_blank" rel="noopener noreferrer" style={wrap}>
