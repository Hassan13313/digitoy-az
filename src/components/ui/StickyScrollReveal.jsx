...
const STEPS = {
  az: [
    { title: 'Paket Seçin',         desc: 'Tədbirinizə uyğun imkanları müqayisə edin və sizə ən uyğun paketi seçin.',  tag: '1 dəqiqə' },
    { title: 'Formu Doldurun',      desc: 'Ad-soyadlar, tarix, məkan, geyim tərzi, foto qalereya — hamısı addım-addım asancasına.',       tag: '5 dəqiqə' },
  ...
  en: [
    { title: 'Choose a Package',    desc: 'Compare the features that suit your event and choose the package that\'s right for you.',    tag: '1 minute' },
  ...
  ru: [
    { title: 'Выберите пакет',      desc: 'Сравните возможности для вашего мероприятия и выберите наиболее подходящий пакет.',      tag: '1 минута' },
