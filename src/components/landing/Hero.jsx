...
const EXTRA_FAQS = {
  az: [
    ...
    { q: 'Qonaqlar dəvətnaməni necə açır?', a: 'Siz qonaqlara WhatsApp, Telegram və ya e-poçt vasitəsilə unikal link göndərirsiniz. Qonaqlar tətbiq yükləmədən birbaşa öz smartfon brauzerindən açır — heç bir əlavə proqram lazım deyil.' },
    ...
    { q: 'Fərdi dizayn tələb etsəm nə etməliyəm?', a: 'Premium paket çoxsaylı fərdiləşdirmə variantlarını əhatə edir: şrift seçimi, rəng paleti, musiqi, foto qalereya, dərs kodu vizualizasiyası. Daha spesifik istəklər üçün WhatsApp vasitəsilə bizimlə əlaqə saxlayın.' },
    { q: 'Ödəniş necə edilir?', a: 'Sifarişi WhatsApp vasitəsilə yerləşdirdikdən sonra operatorumuz sizinlə əlaqə saxlayır. Ödəniş bank köçürməsi (Kapital Bank, ABB) və ya nağd şəkildə həyata keçirilir. Hər iki variantda qəbz göndərilir.' },
  ...
  en: [
    ...
    { q: 'How do guests open the invitation?', a: 'You send guests a unique link via WhatsApp, Telegram, or email. They open it directly in their smartphone browser — no app download required.' },
    ...
    { q: 'What if I need custom design?', a: 'The Premium package includes extensive customization: fonts, color palette, music, photo gallery, and dress code visualization. For specific requests contact us via WhatsApp.' },
    { q: 'How do I pay?', a: 'After placing your order via WhatsApp, our team contacts you. Payment is made via bank transfer or cash. A receipt is provided either way.' },
  ...
  ru: [
    ...
    { q: 'Как гости открывают приглашение?', a: 'Вы отправляете гостям уникальную ссылку через WhatsApp, Telegram или email. Они открывают её напрямую в браузере смартфона — без загрузки приложений.' },
    ...
    { q: 'Что если нужен индивидуальный дизайн?', a: 'Пакет Premium включает множество вариантов персонализации: шрифт, цветовая палитра, музыка, фотогалерея. Для специфических запросов свяжитесь через WhatsApp.' },
    { q: 'Как произвести оплату?', a: 'После оформления заказа наша команда свяжется с вами. Оплата осуществляется банковским переводом или наличными. Чек предоставляется в любом случае.' },
...
export function FAQSection({ lang = 'az' }) {
  ...
  const faqs = [...baseFaqs, ...(EXTRA_FAQS[lang] || EXTRA_FAQS.az)]
