...
const NAV_TABS = {
  az: [
    { id: 'why',      label: 'Niyə Digitoy' },
    { id: 'features', label: 'Xüsusiyyətlər' },
    { id: 'packages', label: 'Paketlər' },
    { id: 'faq',      label: 'Suallar' },
  ],
  en: [
    { id: 'why',      label: 'Why Digitoy' },
    { id: 'features', label: 'Features' },
    { id: 'packages', label: 'Packages' },
    { id: 'faq',      label: 'FAQ' },
  ],
  ru: [
    { id: 'why',      label: 'Почему Digitoy' },
...
export default function LandingPage({ lang, setLang, weddingData, setWeddingData, onViewInvitation, onDemo, isAdmin = false, initialShowPreview = false }) {
  ...
  const handleTabClick = (tab) => {
    ...
    if (tab.id === 'why')      { scrollToSection('features'); return }
    if (tab.id === 'features') { scrollToSection('sample-section'); return }
